...
#from matsuoka_walk.oscillator_2 import oscillator_nw
# oscillator_2_1 has corrected up_time calculation
from matsuoka_walk.oscillator_2_1 import oscillator_nw
