...
from matsuoka_walk.oscillator_3 import oscillator_nw
...
log('[GA] FLT_MIN_K={0}, FLT_MAX_K={1}'.format(FLT_MIN_K, FLT_MAX_K))
...
toolbox.register("k_flt", random.uniform, FLT_MIN_K, FLT_MAX_K)
