# Script with low level feedback for all angles
...
FLT_MIN_K_KNEE_Y, FLT_MAX_K_KNEE_Y = -2.5, 2.5
FLT_MIN_K_ANKLE_Y, FLT_MAX_K_ANKLE_Y = -2.5, 2.5
FLT_MIN_K_HIP_X, FLT_MAX_K_HIP_X = -2.5, 2.5
FLT_MIN_K_ANKLE_X, FLT_MAX_K_ANKLE_X = -2.5, 2.5
FLT_MIN_K_SHOULDER_Y, FLT_MAX_K_SHOULDER_Y = -2.5, 2.5
...
log('[GA] FLT_MIN_K_HIP_Y={0}, FLT_MAX_K_HIP_Y={1}'.format(FLT_MIN_K_HIP_Y, FLT_MAX_K_HIP_Y))
log('[GA] FLT_MIN_K_KNEE_Y={0}, FLT_MAX_K_KNEE_Y={1}'.format(FLT_MIN_K_KNEE_Y, FLT_MAX_K_KNEE_Y))
log('[GA] FLT_MIN_K_ANKLE_Y={0}, FLT_MAX_K_ANKLE_Y={1}'.format(FLT_MIN_K_ANKLE_Y, FLT_MAX_K_ANKLE_Y))
log('[GA] FLT_MIN_K_HIP_X={0}, FLT_MAX_K_HIP_X={1}'.format(FLT_MIN_K_HIP_X, FLT_MAX_K_HIP_X))
log('[GA] FLT_MIN_K_ANKLE_X={0}, FLT_MAX_K_ANKLE_X={1}'.format(FLT_MIN_K_ANKLE_X, FLT_MAX_K_ANKLE_X))
log('[GA] FLT_MIN_K_SHOULDER_Y={0}, FLT_MAX_K_SHOULDER_Y={1}'.format(FLT_MIN_K_SHOULDER_Y, FLT_MAX_K_SHOULDER_Y))
...
toolbox.register("k_hip_y_flt", random.uniform, FLT_MIN_K_HIP_Y, FLT_MAX_K_HIP_Y)
toolbox.register("k_knee_y_flt", random.uniform, FLT_MIN_K_KNEE_Y, FLT_MAX_K_KNEE_Y)
toolbox.register("k_ankle_y_flt", random.uniform, FLT_MIN_K_ANKLE_Y, FLT_MAX_K_ANKLE_Y)
toolbox.register("k_hip_x_flt", random.uniform, FLT_MIN_K_HIP_X, FLT_MAX_K_HIP_X)
toolbox.register("k_ankle_x_flt", random.uniform, FLT_MIN_K_ANKLE_X, FLT_MAX_K_ANKLE_X)
toolbox.register("k_shoulder_y_flt", random.uniform, FLT_MIN_K_SHOULDER_Y, FLT_MAX_K_SHOULDER_Y)
...
toolbox.register("individual", tools.initCycle, creator.Individual,
                 (toolbox.kf_flt,
                  ...
                  toolbox.k_hip_y_flt, toolbox.k_knee_y_flt, toolbox.k_ankle_y_flt,
                  toolbox.k_hip_x_flt, toolbox.k_ankle_x_flt,
                  toolbox.k_shoulder_y_flt),
                 n=N_CYCLES)
